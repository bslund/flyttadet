...
public class RegistrationTest extends MembershipTestBase
{
    ...
    @Mock
    SiteUserDataPolicy userDataPolicy;
        ...
        throws Exception
    {
        ...
        SiteUserDataPolicy userData = mock(SiteUserDataPolicy.class);
...
//        login
        ...
        verify(userDataHandler).commitUserData(any(SiteUserDataPolicy.class));
    }
